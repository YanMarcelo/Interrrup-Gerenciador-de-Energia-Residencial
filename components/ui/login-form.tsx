          ...
          <form className="p-6 md:p-8">
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl text-[var(--primary-color)] font-bold">Bem-vindo de volta !</h1>
              ...
              <Field>
                <Button className="bg-[var(--primary-color)] hover:bg-slate-950" type="submit"><a href="/dashboard">Login</a></Button>
              </Field>
